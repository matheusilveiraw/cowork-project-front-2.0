          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <tr v-for="cliente in clientes" :key="cliente.idCustomer">
                ...
                <td>
                  <button class="btn btn-sm btn-outline-primary mr-1" @click="abrirModalEdicao(cliente)" title="Editar cliente">
                    <i class="tim-icons icon-pencil"></i>
                  </button>
                  <button class="btn btn-sm btn-outline-danger" @click="confirmarExclusao(cliente)" title="Excluir cliente">
